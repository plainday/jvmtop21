...
public class JvmTop
{
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    else
    {
      ...
      if (pid == null)
      {
        System.err.println("Scanning JVMs, please wait...");
      ...
      else
      {
        if (profileMode)
        {
          System.err.printf("Connecting to PID %d, please wait...%n", pid);
  ...
  protected void run(ConsoleView view) throws Exception
  {
    try
    {
      ...
      while (!view.shouldExit())
      {
        ...
        if (iterations == 0)
        {
          // Flush header immediately so the user sees progress while
          // the first printView() call does JMX connect / VM scanning.
          System.out.print(" Initializing, please wait...\n\n");
          System.out.flush();
        }
        view.printView();
        System.out.flush();
  ...
  {
    System.out.printf(" JvmTop - %8tT, %6s, %2d cpus, %15.15s",
