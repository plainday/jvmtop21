...
public class VMOverviewView extends AbstractConsoleView
{
  ...
  public void printView() throws Exception
  {
    ...
    for (VMInfo vmInfo : vmInfoList)
    {
      ...
      {
        // Silently exclude: attach failed (e.g. self-attach with allowAttachSelf=false,
        // or a VM that exited before we could attach). No error row is shown.
        // If allowAttachSelf=true and self-attach succeeds, state becomes ATTACHED
        // and the row is printed normally above.
      }
